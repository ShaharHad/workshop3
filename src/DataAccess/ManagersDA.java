...
public class ManagersDA implements DataAccess<Manager> {
    private static final ManagersDA instance = new ManagersDA();

    //private constructor to avoid client applications to use constructor
    public static ManagersDA getInstance() { return instance; }
    private ManagersDA() {}
    ...
    public Manager get(Map<String, String> keyParams) {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                manager = new Manager(userNameRS, member.getPassword(), member.getName(),member.getRole(), teamNameRS);
            }
            preparedStmt.close();
            conn.close();
        }
